...
namespace ScholarshipManagementAPI.Controllers.SuperAdmin
{
    ...
    public class LanguagesController : ControllerBase
    {
        ...
        [HttpPost("create")]
        [Authorize]
        public async Task<IActionResult> Create(LanguageRequestDto dto)
        {
        ...
        [Authorize]
        public async Task<IActionResult> Update(long id, [FromBody] LanguageRequestDto dto)
        {
            dto.LanguageId = id;
        ...
        [HttpPost("search")]
        [Authorize]
        public async Task<IActionResult> GetByFilter(LanguageFilterDto filter)
        {
