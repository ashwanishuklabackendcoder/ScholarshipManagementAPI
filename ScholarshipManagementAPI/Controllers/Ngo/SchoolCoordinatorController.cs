...
{
    [ApiController]
    [Route("api/ngo/school-coordinators")]
    public class SchoolCoordinatorController : ControllerBase
    {
        private readonly ISchoolCoordinatorService _service;
        private readonly CurrentUserContextService _currentUserContext;

        public SchoolCoordinatorController(
            ISchoolCoordinatorService service,
        ...
        [HttpPost("create")]
        [Authorize]
        public async Task<IActionResult> Create([FromBody] SchoolCoordinatorRequestDto dto)
        {
        ...
        [Authorize]
        public async Task<IActionResult> Update(long staffId, [FromBody] SchoolCoordinatorRequestDto dto)
        {
            dto.StaffId = staffId;
            var currentUser = await _currentUserContext.GetCurrentUserAsync();
            ...
            return Ok(new ApiResponseDto
            {
                Success = true,
                Result = updated,
                Message = "School coordinator updated successfully."
            });
        }
        ...
        public async Task<IActionResult> Delete(long staffId)
        {
            ...
            return Ok(new ApiResponseDto
            {
                Success = true,
                Result = deleted,
                Message = "School coordinator deleted successfully."
            });
        }
        ...
        [HttpPost("search")]
        [Authorize]
        public async Task<IActionResult> Search([FromBody] SchoolCoordinatorFilterDto filter)
        {
