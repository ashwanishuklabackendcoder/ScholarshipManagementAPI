...
namespace ScholarshipManagementAPI.Services.Implementation.University
{
    public class ProgramRegistrationWindowService : IProgramRegistrationWindowService
    {
        ...
        public async Task<ProgramRegistrationWindowRequestDto?> GetByProgramIdAsync(long programId)
        {
        ...
        public async Task<long> SaveAsync(ProgramRegistrationWindowRequestDto dto,long loginId)
        {
